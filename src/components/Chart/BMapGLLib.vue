  ...
  <div class="home">
    ...
    <ul class="drawing-panel">
      <li
        ...
        @click="draw('marker')"
        :style="{
          'background-position-y': actNav === 'marker' ? '-52px' : '0px',
        }"
      ></li>
      <li
        ...
        @click="draw('polyline')"
        :style="{
          'background-position-y': actNav === 'polyline' ? '-52px' : '0px',
        }"
      ></li>
      <li
      ...
      <li
        ...
        @click="draw('circle')"
        :style="{
          'background-position-y': actNav === 'circle' ? '-52px' : '0px',
        }"
      ></li>
    </ul>
    <!-- 地图容器 -->
...
<script>
import { loadBaiDuDrawMap } from "./js/bmpgl_lib.js";
export default {
  name: "home",
  data() {
    return {
